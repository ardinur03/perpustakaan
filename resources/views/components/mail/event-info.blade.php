    ...
    <style>
        * {
        ...
        @media (max-width:720px) {
            ...
            .row-1 .column-2 .block-2.text_block td.pad {
            ...
            <tr>
                <td>
                    ...
                    <table class="row row-2" align="center" width="100%" border="0" cellpadding="0"
                        cellspacing="0" role="presentation"
                        style="mso-table-lspace:0;mso-table-rspace:0;background-color:#4a65ad;background-image:url(https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/0db9f180-d222-4b2b-9371-cf9393bf4764/a31367d3-56d9-4984-bf48-79331695a0bc/galaxy-bg.png);background-position:top center;background-repeat:no-repeat">
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                                                ...
                                                                <div style="font-family:sans-serif">
                                                                    <div class
                                                                        ...
                                                                        <p
                                                                            style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:24px">
                                                                            <span style="font-size:16px;">
                                                                                Ayo ramaikan acara ini dengan hadirnya
                                                                                kamu, dan jangan lupa untuk meramaikan
                                                                                tagar
                                                                                #KampuskuMembaca !
                                                                            </span>
                                                                        </p>
                                                            ...
                                                            <td class="pad">
                                                                <div style="font-family:sans-serif">
                                                                    <div class
                                                                        ...
                                                                        <p
                                                                            style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
                                                                            <span style="font-size:12px;"><strong>&copy;
                                                                                    Copyright | Perpustakaan
                                                                                    WebApp</strong></span>
                                                                        </p>
                                                                        <p
                                                                            style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
                                                                            <span style="font-size:12px;">Dibuat dengan
                                                                                <span style="color: red"> ❤ </span>di
                                                                                Bandung</span>
                                                                        </p>
                                                                        <p
                                                                            style="margin:0;font-size:14px;text-align:center;mso-line-height-alt:16.8px">
