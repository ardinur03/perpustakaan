            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('study_name') is-invalid @enderror" id="exampleInputName" placeholder="Study Name" name="study_name" value="{{old('study_name')}}">
